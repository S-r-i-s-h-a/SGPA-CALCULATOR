...
public class x8x15  extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tt=findViewById(R.id.textView6);
        tt.setText("8th Sem");
        ...
        et2=findViewById(R.id.editText16);
        et2.setHint("15XX83");
        ss2=et2.getText().toString();


        et3=findViewById(R.id.editText26);
        et3.setHint("15XX84X");
        ss3=et3.getText().toString();


        et4=findViewById(R.id.editText36);
        et4.setHint("15XX85X");
        ss4 =et4.getText().toString();


        et5=findViewById(R.id.editText46);
        et5.setHint("15XXL86");
        ...
        Button bb=findViewById(R.id.b16);
        ...
        dropdown = findViewById(R.id.spin16);
        drpdown = findViewById(R.id.spin26);
        d3=findViewById(R.id.spin36);
        d4=findViewById(R.id.spin46);
        d5=findViewById(R.id.spin56);
        d6=findViewById(R.id.spin66);
    ...
    public void onClick(View view) {
        try{
            ...
            double sg=((gp1*c1) +(gp2*c2)+(gp3*c3)+(gp4*c4)+(gp5*c5)+(gp6*c6))/(c1+c2+c3+c4+c5+c6);
